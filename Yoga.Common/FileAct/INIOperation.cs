...
namespace Yoga.Common.FileAct
{
    public class INIOperation
    {
        ...
        /// <summary>
        /// 读取INI文件中指定KEY的字符串型值,读取失败 就将默认值写入到ini文件中
        /// </summary>
        /// <param name="iniFile">Ini文件</param>
        /// <param name="section">节点名称</param>
        ...
        public static string GetValue(string iniFile, string section, string key, string defaultValue)
        {
            ...
            try
            {
                ...
                uint bytesReturned = GetPrivateProfileString(section, key, null, sb, SIZE, iniFile);
                ...
                else
                {
                    ...
                    {
                        WriteValue(iniFile, section, key, defaultValue);
                    }
                }
                sb = null;
            }
