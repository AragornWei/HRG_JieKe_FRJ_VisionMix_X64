...
namespace Yoga.Common.MotionControl
{
    public abstract class MoveCard : CommBase
    {
        ...
        public virtual void HomeAll()
        {
            ...
            homeFinish = false;
            Task home1 = Task.Run(() => Homing(1, -2000000));  //异步回原点
            Task home2 = Task.Run(() => Homing(2, 2000000));  //异步回原点
            Task home3 = Task.Run(() => Homing(3, 2000000)); //异步回原点
