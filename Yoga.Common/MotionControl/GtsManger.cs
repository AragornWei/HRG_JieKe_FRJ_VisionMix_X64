...
namespace Yoga.Common.MotionControl
{
    public class GtsManger
    {
        ...
        public void Init()
        {
            ...
            gts.mc.GT_ClrSts(1, 2);//清除各轴报警和限位
            for (int i = 0; i < 2; i++)
            {
        ...
        public void WaitMoved(short axis)
        {
            ...
            do
            {
                ...
                System.Windows.Forms.Application.DoEvents();//这个很巧妙

            } while (0x800 != (sts & 0x800));              //0x800表示轴在运动标志：状态字的位10，位11表示到位标志。
        }
